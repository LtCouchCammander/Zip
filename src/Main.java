public class Main {
    ...
    2. Adding in the game logic (Numbers throughout the grid, and you have to go through each one from lowest to highest while filling in all the grids squares).
